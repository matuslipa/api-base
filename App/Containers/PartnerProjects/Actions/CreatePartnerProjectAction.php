 ...
 */
final class CreatePartnerProjectAction
{
    /**
     ...
     * @throws \Throwable
     */
    public function run(PartnerProjectInputData $data): PartnerProject
    {
        return $this->databaseManager->transaction(function () use ($data): PartnerProject {
            $partnerProject = $this->partnerProjectsRepository->create($data->getAttributes());
