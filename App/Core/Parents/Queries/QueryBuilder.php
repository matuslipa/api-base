...
class QueryBuilder extends Builder implements QueryBuilderInterface
{
    ...
    {
        /** @var \App\Core\Parents\Models\Model|null $model */
        $model = $this->first();
        return $model;
    }
    ...
    {
        if ($this->getModel()->getKeyType() === CastTypesEnum::INT) {
     ...
     * @inheritDoc
     */
    public function withAuthorizationRelations(?PermissionEnum $permission = null): self
    {
        return $this;
    }
